...
public static class ResponseConstants
{
    ...
    public const string  NoteTaskAndProjectLinkedSameTime = "You cannot link a note to a task and a project at the same time.";
   
    // Project
    public static string ProjectNotExists(Guid projectId) => $"The project with id: '{projectId}' does not exist.";
    public static string ProjectStatusNotExists(int projectStatusId) => $"The project status with ID: '{projectStatusId}' does not exist.";
    ...
    public const string  ProjectStatusDescriptionIsLongerThanAllowed = "The project status description length is longer than allowed.";
    public const string  ProjectStatusNameColorIsLongerThanAllowed = "The project status name-color length is longer than allowed.";
    public const string  ProjectStatusBackgroundColorIsLongerThanAllowed = "The project status background-color length is longer than allowed.";
    
    
    // Task
    public static string TaskNotExists(Guid taskId) => $"The task with id: '{taskId}' does not exist.";
    public static string TaskStatusNotExists(int taskStatusId) => $"The task status with ID: '{taskStatusId}' does not exist.";
    ...
    public const string  TaskStatusDescriptionIsLongerThanAllowed = "The task status description length is longer than allowed.";
    public const string  TaskStatusNameColorLongerThanAllowed = "The task status name-color length is longer than allowed.";
    public const string  TaskStatusBackgroundColorIsLongerThanAllowed = "The task status background-color length is longer than allowed.";
}